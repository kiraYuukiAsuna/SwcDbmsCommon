...
& "$ProtobufPath/protoc.exe" `
    ...
    --plugin=protoc-gen-go-grpc=$ProtobufPath/protoc-gen-go-grpc.exe `
    --go_out=Generated/go `
...
& "$ProtobufPath/protoc.exe" `
    -I=Bin/protobuf/include `
    -I=proto proto/Service/* `
    --plugin=protoc-gen-grpc-gateway=$ProtobufPath/protoc-gen-grpc-gateway.exe `
...
& "$ProtobufPath/protoc.exe" `
    ...
    --plugin=protoc-gen-openapiv2=$ProtobufPath/protoc-gen-openapiv2.exe `
