...
func (c *dBMSClient) GetAllFreeSwcMetaInfo(ctx context.Context, in *request.GetAllFreeSwcMetaInfoRequest, opts ...grpc.CallOption) (*response.GetAllFreeSwcMetaInfoResponse, error) {
	out := new(response.GetAllFreeSwcMetaInfoResponse)
	err := c.cc.Invoke(ctx, DBMS_GetAllFreeSwcMetaInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DBMS_GetAllFreeSwcMetaInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(request.GetAllFreeSwcMetaInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DBMSServer).GetAllFreeSwcMetaInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DBMS_GetAllFreeSwcMetaInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DBMSServer).GetAllFreeSwcMetaInfo(ctx, req.(*request.GetAllFreeSwcMetaInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
