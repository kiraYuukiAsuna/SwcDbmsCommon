...
::grpc::Status DBMS::Stub::GetAllFreeSwcMetaInfo(::grpc::ClientContext* context, const ::proto::GetAllFreeSwcMetaInfoRequest& request, ::proto::GetAllFreeSwcMetaInfoResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::proto::GetAllFreeSwcMetaInfoRequest, ::proto::GetAllFreeSwcMetaInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetAllFreeSwcMetaInfo_, context, request, response);
}

void DBMS::Stub::async::GetAllFreeSwcMetaInfo(::grpc::ClientContext* context, const ::proto::GetAllFreeSwcMetaInfoRequest* request, ::proto::GetAllFreeSwcMetaInfoResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::proto::GetAllFreeSwcMetaInfoRequest, ::proto::GetAllFreeSwcMetaInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAllFreeSwcMetaInfo_, context, request, response, std::move(f));
}

void DBMS::Stub::async::GetAllFreeSwcMetaInfo(::grpc::ClientContext* context, const ::proto::GetAllFreeSwcMetaInfoRequest* request, ::proto::GetAllFreeSwcMetaInfoResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAllFreeSwcMetaInfo_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::proto::GetAllFreeSwcMetaInfoResponse>* DBMS::Stub::PrepareAsyncGetAllFreeSwcMetaInfoRaw(::grpc::ClientContext* context, const ::proto::GetAllFreeSwcMetaInfoRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::proto::GetAllFreeSwcMetaInfoResponse, ::proto::GetAllFreeSwcMetaInfoRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetAllFreeSwcMetaInfo_, context, request);
}

::grpc::ClientAsyncResponseReader< ::proto::GetAllFreeSwcMetaInfoResponse>* DBMS::Stub::AsyncGetAllFreeSwcMetaInfoRaw(::grpc::ClientContext* context, const ::proto::GetAllFreeSwcMetaInfoRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetAllFreeSwcMetaInfoRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
DBMS::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      DBMS_method_names[60],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DBMS::Service, ::proto::GetAllFreeSwcMetaInfoRequest, ::proto::GetAllFreeSwcMetaInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](DBMS::Service* service,
             ::grpc::ServerContext* ctx,
             const ::proto::GetAllFreeSwcMetaInfoRequest* req,
